...
export const useCases: UseCase[] = [
  {
    ...
    metaDescription: 'Use Agent Vision to let AI agents QA test native macOS apps. Discover buttons, fill forms, verify UI states, and report bugs in any app.',
  ...
  },
  {
    ...
    metaDescription: 'Automate form filling across any macOS app with Agent Vision. Discover input fields, type values, tab between them, and submit. No scripting.',
  ...
  },
  {
    ...
    metaDescription: 'Enable AI agents to see what changed after every action with Agent Vision. The capture-analyze-act loop gives agents visual feedback in any macOS app.',
  ...
  },
  {
    ...
    metaDescription: 'Use Agent Vision to let AI agents work across macOS apps. Copy from spreadsheets, paste into web forms, verify in database tools, with no API needed.',
  ...
  },
  {
    ...
    metaDescription: 'Use Agent Vision to let one AI agent control another. Claude Code orchestrates a second Claude Code instance through its visual terminal interface.',
  ...
  },
  {
    ...
    metaDescription: 'Use Agent Vision to automate web apps that have no API. Control Jira, Notion, Google Forms, or legacy admin panels visually. No keys, OAuth, or webhooks.',
  ...
  },
  {
    ...
    metaDescription: 'Use Agent Vision to test iOS apps in the Simulator without Appium or XCUITest. Screenshot, discover UI elements, tap, swipe, and verify on screen.',
  ...
  },
  {
    ...
    metaDescription: 'Use Agent Vision as the Zapier for your desktop. Chain Mail.app, Calendar, Slack, and spreadsheets into AI workflows without any integrations.',
